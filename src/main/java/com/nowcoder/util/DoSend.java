...
public class DoSend {
    ...
    private String from = "tongxupeng@126.com"; // 发件人邮箱地址
    private String user = "tongxupeng@126.com"; // 发件人称号，同邮箱地址
    private String password = "xxr5201314"; // 发件人邮箱客户端授权码
    ...
    public static void main(String[] args) throws Exception { // 做测试用
        ...
        msg.setSubject("哈哈哈....");
        msg.setText("你好!这是我的第san个javamail程序---WQ");
        msg.setFrom(new InternetAddress("tongxupeng@126.com"));//发件人邮箱(我的163邮箱)
        msg.setRecipient(Message.RecipientType.TO,
                new InternetAddress("503709246@qq.com")); //收件人邮箱(我的QQ邮箱)
        msg.saveChanges();
